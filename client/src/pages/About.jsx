  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-800">
        About Whitelake Estate
      </h1>
      <p className="mb-4 text-slate-700">
        Whitelake Estate is a leading real estate agency the specializes in
      ...
      <p className="mb-4 text-slate-700">
        ...
        should be an exciting and rewarding experince, and we are dedicated to
        making that a reality for each and every one of our client.
      </p>
    </div>
  );
}
